      ...
      <div className="container">
        <div className="row g-5">
          ...
          <div className="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
            ...
            <h1 className="mb-4">
              Welcome to <span className="text-primary">R&RTravel</span>
            </h1>
            <p className="mb-4">
            Discover the world with R&R Travel! 30+ years of expertise in crafting your dream journeys across India and exotic foreign destinations.
            </p>
            <p className="mb-4">
