        ...
        <div className="row g-5">
          ...
          <div className="col-lg-3 col-md-6">
            ...
            <p className="mb-2">
              ...
              R&R Travels, Durtlang Rd, near Greenwood hospital thlang, Bawngkawn, Aizawl, Mizoram 796014
            </p>
            <p className="mb-2">
            ...
            <div className="d-flex pt-2">
              ...
              <a className="btn btn-outline-light btn-social" href="https://www.facebook.com/rrtravelsazl/">
